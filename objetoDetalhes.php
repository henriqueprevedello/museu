...
<header>
  <div class="row">
    <div class="col-sm-12" style="margin: 20px 0;">
      <h2 style="text-align: center; "><?php echo $objeto->tx_nome ?></h2>
    </div>
  </div>
</header>

<div class="row">
  <label for="example-date-input" class="col-12 col-form-label">Descrição:</label>
</div>

<div class="row">

  <div class="form-group col-md-12">
    <input disabled type="text" class="form-control" placeholder="Descrição" name="tx_descricao" value="<?= ($id_objeto != null) ? $objeto->tx_descricao : "" ?>">
  </div>
...
<div class="row">
  <div class="form-group col-12">
    <input disabled type="date" class="form-control" name="dt_criacao" value="<?= ($id_objeto != null) ? $objeto->dt_criacao : adquirirDataAtual() ?>">
  </div>
</div>

<div class="row">
  <label for="example-date-input" class="col-12 col-form-label">Status:</label>
</div>

<div class="row">

  <div class="form-group col-md-12">
    <select disabled class="form-control" name="cd_status">
...
<div class="row">
  <label for="example-date-input" class="col-12 col-form-label">Categoria:</label>
</div>

<div class="row">

  <div class="form-group col-md-12">
    <select disabled class="form-control" name="cd_categoria">
...
<div class="row">
  <label for="example-date-input" class="col-12 col-form-label">Espaço:</label>
</div>

<div class="row">

  <div class="form-group col-md-12">
    <select disabled class="form-control" name="cd_espaco">
...
<?php if (!empty($anexos)) {
  echo '<div class="row">
  <label for="example-date-input" class="col-12 col-form-label">Anexos:</label>
</div>';
} ?>
