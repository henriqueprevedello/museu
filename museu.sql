...
ALTER TABLE `tb_objeto_categoria`
ADD PRIMARY KEY (`cd_objeto`, `cd_categoria`),
ADD CONSTRAINT `fk_objeto_categoria_objeto` FOREIGN KEY ( `cd_objeto` ) REFERENCES `tb_objeto` ( `id_objeto` ),
ADD CONSTRAINT `fk_objeto_categoria_categoria` FOREIGN KEY ( `cd_categoria` ) REFERENCES `tb_categoria` ( `id_categoria` );
